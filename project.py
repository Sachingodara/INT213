        ...
        if (flag == 1):
            ...
            if (now.day > ttime.day):
                ...
                if ttime.day == now.day and ttime.hour == now.hour and now.minute <= ttime.minute + 20:
                    tkMessageBox.showinfo("Track Order",
...
def Customer():
    ...
    button_3 = Button(cust_window, text="Track Order", bg="light blue", relief="raised", height="5", width="10",
                      command=Track)
...
button_m1 = Button(window, text=" Customer ", bg="light green", height="4", width="15", relief="raised",
                   command=Customer)
